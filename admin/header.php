...
<head>
  ...
  <link rel="icon" href="../assets/images/logo/fav-icon.png" type="image/x-icon">
  <link rel="shortcut icon" href="../assets/images/logo/fav-icon.png" type="image/x-icon">
  <title>TrendAura Dashboard</title>
  ...
  <script type="text/javascript" src="../assets/js/admin-toast.js"></script>
