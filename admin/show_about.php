                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5>Show About Us</h5>
                                        <div>
                                            <input type="text" id="searchBar" class="form-control form-control-sm" placeholder="Search About">
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table align-middle mb-0" id="aboutTable">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">Id</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchSearchResults(searchQuery) {
                $.ajax({
                    url: 'fetch_about.php', // PHP file that handles search and returns the result
                    method: 'POST',
                    data: { search: searchQuery }, // Send the search query to the PHP file
                    success: function(response) {
                        $('#aboutTable tbody').html(response); // Update the table with the search results
                    }
                });
            }
